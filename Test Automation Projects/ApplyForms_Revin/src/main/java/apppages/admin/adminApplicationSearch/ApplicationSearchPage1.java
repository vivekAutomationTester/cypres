...
public class ApplicationSearchPage1 extends BasePage {
     ...
     */
    public ApplicationSearchPage1(DriverObj driverObj) {
        super(driverObj);
    }
    ...
    public ApplicationSearchPage1 searchForApplication(String applicationId) throws Exception {
    ...
    public ApplicationSearchPage1 verifyApplicationStatus(String groundTruthStatus) throws Exception {
